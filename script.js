...
document.addEventListener('DOMContentLoaded', () => {
  const projectsData = [
    { 
      ...
      altImage: 'сайта Different Store' 
    },
    {
      ...
      image: 'learn-python', 
      date: '10.05.2023 - н.в.', 
      altImage: 'сайта для изучения python' 
    },
    {
      ...
      image: 'procrastinate', 
      date: '09.09.2022', 
      altImage: 'лендинга Procrastinate.' 
    },
    {
      ...
      image: 'aloha', 
      date: '29.08.2022', 
      altImage: 'лендинга web-студии aloha'
    }
  ];
  ...
  projectsData.forEach((project) => {
    ...
    const projectContent = `
      ...
      <div class="project-img">
        <img src="img/project-${project.image}.png" alt="Скриншот главной страницы ${project.altImage}">
      </div>
    `;
